...
public class AspectOfTheVoidItem extends SwordItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        components.add(Component.literal("Ability: Instant Transmission").withStyle(ChatFormatting.GOLD));
        components.add(Component.literal("RIGHT CLICK").withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.BOLD));
        components.add(Component.literal("Teleport 12 blocks ahead of").withStyle(ChatFormatting.GRAY));
        components.add(Component.literal("you and gain +50 Speed").withStyle(ChatFormatting.GRAY));
        components.add(Component.literal("for 3 seconds").withStyle(ChatFormatting.GRAY));
        components.add(Component.literal("Mana Cost: 45").withStyle(ChatFormatting.DARK_GRAY));
