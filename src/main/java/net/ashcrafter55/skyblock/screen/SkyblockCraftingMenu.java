...
public class SkyblockCraftingMenu extends AbstractContainerMenu {
    ...
    public SkyblockCraftingMenu(int id, Inventory inv, FriendlyByteBuf buf) {
        this(id, inv, ContainerLevelAccess.NULL);
    }

    public SkyblockCraftingMenu(int id, Inventory inv, ContainerLevelAccess access) {
